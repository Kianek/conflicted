...
var _mongooseConfig = _interopRequireDefault(require("./config/mongoose-config"));

var _users = _interopRequireDefault(require("./routes/users"));

var _clients = _interopRequireDefault(require("./routes/clients"));

var _cases = _interopRequireDefault(require("./routes/cases"));
...
(0, _mongooseConfig["default"])(process.env.ATLAS_URI);
var app = (0, _express["default"])();
app.use((0, _helmet["default"])());
app.use((0, _cors["default"])());
app.use((0, _morgan["default"])('combined'));
app.use(_express["default"].json());
app.get('/api/sanity-check', function (req, res) {
