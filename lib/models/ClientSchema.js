...
var _AddressSchema = _interopRequireDefault(require("./AddressSchema"));

var _CaseSchema = _interopRequireDefault(require("./CaseSchema"));
...
var ClientSchema = new Schema({
  ...
  addresses: [_AddressSchema["default"]],
  cases: [_CaseSchema["default"]]
}, {
  timestamps: true
});
